...
export NVHPC_HOME="$(prefix_for "nvhpc@25.11")"
export BINUTILS_HOME="$(prefix_for "binutils@2.42 %gcc@12.2.0")"
export NCCL_HOME="$(prefix_for "nccl@2.22.3-1 %nvhpc@25.11 cuda_arch=80")"
export CUDNN_HOME="$(prefix_for "cudnn@9.2.0.82-12 %nvhpc@25.11")"
export HDF5_HOME="$(prefix_for "hdf5@1.14.3 %nvhpc@25.11")"
export PNETCDF_HOME="$(prefix_for "parallel-netcdf@1.12.3 %nvhpc@25.11")"
export NETCDF_C_HOME="$(prefix_for "netcdf-c@4.9.2 %nvhpc@25.11")"
export NETCDF_FORTRAN_HOME="$(prefix_for "netcdf-fortran@4.6.1 %nvhpc@25.11")"

add_prefix "cuda@12.2.2"
add_prefix "nvhpc@25.11"
add_prefix "binutils@2.42 %gcc@12.2.0"
add_prefix "nccl@2.22.3-1 %nvhpc@25.11 cuda_arch=80"
add_prefix "cudnn@9.2.0.82-12 %nvhpc@25.11"
add_prefix "hdf5@1.14.3 %nvhpc@25.11"
add_prefix "parallel-netcdf@1.12.3 %nvhpc@25.11"
add_prefix "netcdf-c@4.9.2 %nvhpc@25.11"
add_prefix "netcdf-fortran@4.6.1 %nvhpc@25.11"
