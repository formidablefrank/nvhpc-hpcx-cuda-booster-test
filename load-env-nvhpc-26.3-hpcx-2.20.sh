...
env_dir="${repo_root}/env-nvhpc-26.3-hpcx-2.20"
...
export CUDA_HOME="$(prefix_for "cuda@12.2.2 %nvhpc@26.3")"
...
export HPCX_MPI_HOME="$(prefix_for "hpcx-mpi@2.20")"
export HPCX_HOME="${HPCX_MPI_HOME%/ompi}"
export BINUTILS_HOME="$(prefix_for "binutils@2.42 %gcc@12.2.0")"
export NCCL_HOME="$(prefix_for "nccl@2.22.3-1 %nvhpc@26.3 cuda_arch=80")"
export CUDNN_HOME="$(prefix_for "cudnn@9.23.0.39-12 %nvhpc@26.3")"
...
add_prefix "cuda@12.2.2 %nvhpc@26.3"
add_prefix "hpcx-mpi@2.20"
add_prefix "binutils@2.42 %gcc@12.2.0"
add_prefix "nccl@2.22.3-1 %nvhpc@26.3 cuda_arch=80"
add_prefix "cudnn@9.23.0.39-12 %nvhpc@26.3"
